...
environments {
    ...
    production {
        ...
        grails.serverURL = "http://brouillard.me/fat"
    }
}
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.headbangers.fat.Person'
...
recaptcha {
    ...
    publicKey = "6LfezhoUAAAAAL4yBW2i7I6zp0AV5wjqQQuLhRcv"
    privateKey = props.get("recaptcha.privatekey")
